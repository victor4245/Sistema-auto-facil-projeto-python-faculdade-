# ========================================================
# CadCli.py — Formulário de Cliente
#
...
def mostrar_formulario(parent: tk.Frame):
    ...
    add_linha("CPF/CNPJ", "cpf_cnpj", linha=1, col_inicio=2, largura=24)
    ...
    # Linha 3
    add_linha("UF", "uf", linha=3, col_inicio=0, largura=6)
    add_linha("CEP", "cep", linha=3, col_inicio=2, largura=12)

    # Linha 4
    add_linha("Bairro", "bairro", linha=4, col_inicio=0, largura=30)
    add_linha("Cidade", "cidade", linha=4, col_inicio=2, largura=24)

    # Linha 5
    add_linha("Endereço", "endereco", linha=5, col_inicio=0, largura=40)
    add_linha("Número", "numero", linha=5, col_inicio=2, largura=10)
