...
def salvar(dados):
    ...
    if not arquivo_existe:
        messagebox.showwarning(
            ...
            "Procure o arquivo CadCli.csv dentro da pasta BD_interno"
        )
        return
    ...
    try:
        ...
        messagebox.showinfo(
            "Sucesso",
            "Cliente salvo com sucesso no banco de dados interno!"
        )
...
def mostrar_formulario(parent: tk.Frame):
    ...
    # Linha 3
    add_linha("UF", linha=3, col_inicio=0, largura=6)
    add_linha("CEP", linha=3, col_inicio=2, largura=12)

    # Linha 4
    add_linha("Bairro", linha=4, col_inicio=0, largura=30)
    add_linha("Cidade", linha=4, col_inicio=2, largura=24)
